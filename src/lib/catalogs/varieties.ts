...
export const VARIETIES: RegionalVariety[] = [
  ...
  },
  {
    ...
    recommendedSpacingRowM: [5, 6],
    recommendedSpacingPlantM: [4, 5],
    pollinators: ['Lauranne (autofértil)', 'Makako'],
    notes:
      'Variedad CEBAS de floración extra-tardía (3ª-4ª semana abril). Indicada para zonas con riesgo de helada como Burgos. Cáscara dura, almendra dulce.',
  },
  {
    id: 'prunus-vialfas',
    species: 'Prunus dulcis',
    ...
    recommendedSpacingRowM: [5, 6],
    recommendedSpacingPlantM: [4, 5],
    pollinators: ['Lauranne (autofértil)', 'Penta'],
    notes:
      'Variedad CITA de floración extra-tardía. Junto con Mardía es de las más recomendadas para meseta norte por escapar a heladas tardías de abril.',
  },
  {
    id: 'juglans-chandler',
    ...
    notes:
      'Productividad lateral elevada (>80 % brotes laterales), calidad de cáscara y almendra clara muy demandada en mercado. Sensible a heladas tardías intensas: evitar fondos de valle. Brotación tardía, cosecha mediados sept.',
  },
  {
    id: 'juglans-franquette',
    species: 'Juglans regia',
    commonName: 'Nogal',
    cultivar: 'Franquette',
    suitableForBurgos: true,
    lateFrostRisk: 'LOW',
    floweringPeriod: 'EXTRA_LATE',
    recommendedRootstocks: ['Juglans regia (franco)', 'Paradox híbrido'],
    recommendedSpacingRowM: [9, 11],
    recommendedSpacingPlantM: [8, 10],
    pollinators: ['Ronde de Montignac', 'Meylannaise'],
    notes:
      'Clásica francesa, brotación muy tardía: la opción más segura ante heladas tardías en Burgos. Vigor medio-alto, productividad apical. Cosecha en octubre.',
  },
  {
    id: 'juglans-lara',
    species: 'Juglans regia',
    ...
    recommendedSpacingRowM: [8, 10],
    recommendedSpacingPlantM: [7, 9],
    pollinators: ['Chandler', 'Franquette'],
    notes:
      'Origen francés, productividad lateral alta. Buen polinizador de Chandler, entrada en producción rápida (4-5 años).',
  },
  {
    id: 'corylus-pauetet',
    ...
    recommendedSpacingPlantM: [3, 4],
    pollinators: ['Negret', 'Gironell'],
    notes:
      'Polinizador clásico de Negret en Tarragona. En Burgos solo ensayar en microclimas muy abrigados; floración masculina enero-febrero con riesgo de helada.',
  },
  {
    id: 'corylus-tonda-giffoni',
    species: 'Corylus avellana',
    commonName: 'Avellano',
    ...
    lateFrostRisk: 'HIGH',
    floweringPeriod: 'EARLY',
    recommendedSpacingRowM: [5, 5.5],
    recommendedSpacingPlantM: [3.5, 4.5],
    pollinators: ['Negret', 'Tonda Romana'],
    notes:
      'Italiana, calidad gastronómica reconocida (uso confitería). Sensible al frío seco invernal y a heladas durante floración: ensayos limitados en meseta norte.',
  },
  {
    id: 'pistacia-kerman',
    ...
    lateFrostRisk: 'MEDIUM',
    floweringPeriod: 'MID',
    recommendedRootstocks: ['Pistacia atlantica', 'UCB-1', 'Pistacia terebinthus'],
    recommendedSpacingRowM: [6, 7],
    recommendedSpacingPlantM: [5, 6],
    pollinators: ['Peter (♂)', 'Guerrero (♂, temprano)'],
    notes:
      'Hembra principal en España. Necesita 1.000-1.200 horas de frío (Burgos cumple). Alternancia de cosecha marcada (años "vecero"). Plantar 10-12 % de machos.',
  },
  {
    id: 'pistacia-peter',
    species: 'Pistacia vera',
    ...
    lateFrostRisk: 'MEDIUM',
    floweringPeriod: 'MID',
    recommendedRootstocks: ['Pistacia atlantica', 'UCB-1'],
    recommendedSpacingRowM: [6, 7],
    recommendedSpacingPlantM: [5, 6],
    notes:
      'Polinizador estándar de Kerman. Sincronización buena en años normales; en primaveras frías de Burgos puede retrasarse → conviene reforzar con 2-3 % de Guerrero.',
  },
  {
    id: 'pistacia-sirora',
    species: 'Pistacia vera',
    ...
    pollinators: ['Peter (♂)'],
    notes:
      'Australiana, requiere menos frío (~700-800 h) que Kerman. Menor alternancia, fruto más pequeño. Alternativa para microclimas más cálidos del sur de la provincia.',
  },
  {
    id: 'pistacia-guerrero',
    species: 'Pistacia vera',
    commonName: 'Pistacho',
    cultivar: 'Guerrero (♂)',
    suitableForBurgos: true,
    ...
    recommendedSpacingPlantM: [5, 6],
    notes:
      'Macho de floración más temprana. Útil como complemento de Peter (2-3 % en finca) para asegurar cobertura ante primaveras frías que retrasan a Peter.',
  },
  {
